...
<script>
   $(document).ready(function() 
   {
     $("body").on('change', '.status_enable', function(event) 
     {
       ...
       $('.reg_msg').html('<div class="alert alert-dismissable alert-danger">'+
   			            		'<i class="ti ti-announcement"></i>&nbsp;'+ 
   			            			'<strong>Notification!</strong>'+
   			            			'<p><b>This Functionality is disable in demo</b></p>'+
...
<script>
   ...
   $("body").on('change', '.forgot_pass', function(event) 
   {
     event.preventDefault();
     /* Act on the event */ 
     $('.forgot_pass_status').html('<div class="alert alert-dismissable alert-danger">'+
   			            		'<i class="ti ti-announcement"></i>&nbsp;'+ 
   			            			'<strong>Notification!</strong>'+
   			            			'<p><b>This Functionality is disable in demo</b></p>'+
   			            			'<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;'+
...
<script>
   ...
   $("body").on('change', '.social_login', function(event) 
   {
     event.preventDefault();
     /* Act on the event */  
     $('.social_login').html('<div class="alert alert-dismissable alert-danger">'+
   			            		'<i class="ti ti-announcement"></i>&nbsp;'+ 
   			            			'<strong>Notification!</strong>'+
   			            			'<p><b>This Functionality is disable in demo</b></p>'+
   			            			'<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;'+
